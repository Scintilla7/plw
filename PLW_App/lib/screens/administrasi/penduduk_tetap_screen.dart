...
class PendudukTetapScreen extends StatefulWidget {
  const PendudukTetapScreen({Key? key}) : super(key: key);

  @override
  _PendudukTetapScreenState createState() => _PendudukTetapScreenState();
}

class _PendudukTetapScreenState extends State<PendudukTetapScreen> {
