...
class PendudukPindahScreen extends StatefulWidget {
  const PendudukPindahScreen({Key? key}) : super(key: key);

  @override
  _PendudukPindahScreenState createState() => _PendudukPindahScreenState();
}

class _PendudukPindahScreenState extends State<PendudukPindahScreen> {
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  maxLines: 1,
                  decoration: InputDecoration(
                    labelText: "Alamat Rumah Lama",
                    hintText: "Masukkan Alamat Rumah Lama",
                    prefixIcon: const Icon(
                      Icons.home,
                    ),
                    border: OutlineInputBorder(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Mohon masukkan alamat rumah lama';
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  maxLines: 1,
                  decoration: InputDecoration(
                    labelText: "Alamat Rumah Baru",
                    hintText: "Masukkan Alamat Rumah Baru",
                    prefixIcon: const Icon(
                      Icons.home,
                    ),
                    border: OutlineInputBorder(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Mohon masukkan alamat rumah baru';
                    }
                    return null;
                  },
                ),
